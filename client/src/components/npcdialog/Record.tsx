...
const Record: React.FC = () => {
  ...
  return (
    <RecDiv>
      <svg ref={mainSVGRef} id="mainSVG" xmlns="http://www.w3.org/2000/svg" viewBox="200 150 400 220">
        <defs>
            <filter id="glow" x="-100%" y="-100%" width="250%" height="250%">
                <feGaussianBlur stdDeviation="15" result="coloredBlur" />
                <feOffset dx="0" dy="0" result="offsetblur"></feOffset>
                <feFlood id="glowAlpha" floodColor="red" floodOpacity="1"></feFlood>
            ...
            <filter id="Bevel" filterUnits="objectBoundingBox" x="-10%" y="-10%" width="150%" height="150%">
                ...
                <feSpecularLighting in="blur" surfaceScale="5" specularConstant="0.125" specularExponent="10" result="specOut" lightingColor="white">
            ...
            <filter id="shadow" x="-100%" y="-100%" width="250%" height="250%">
                ...
                <feFlood id="glowAlpha" floodColor="#181618" floodOpacity="0.831"></feFlood>
                <feComposite in2="offsetblur" operator="in"></feComposite>
                <feMerge>
                    <feMergeNode />
                    <feMergeNode in="SourceGraphic"></feMergeNode>
        ...
        <g id="mic" fill="#44484D">
            <rect x="386.5" y="250.4" width="27" height="59.69" rx="13.5" />
        ...
        <g id="shad" filter="url(#shadow)"> 
            <g id="mainLine" filter="url(#glow)"> 
                <line  filter="url(#Bevel)" x1="360.73" y1="260.73" x2="439.27" y2="343.72" fill="none" stroke="#ed002d" strokeLinecap="round" strokeMiterlimit="10" strokeWidth="7"/>
            </g>
        </g>
      </svg>
      마이크를 눌러 녹음을 시작하세요
